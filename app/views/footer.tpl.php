<footer class="main-footer">
        ...
        <div class="row">
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <ul class="list-inline">
              <li class="list-inline-item">
                <a href="<?= $viewVars['socialPage']->twitter->shareUrl ?>" target="_blank" title="twitter" class="text-muted text-hover-primary">
                  <i class="fa fa-twitter">
                  </i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="<?= $viewVars['socialPage']->facebook->shareUrl ?>" target="_blank" title="facebook" class="text-muted text-hover-primary">
                  <i class="fa fa-facebook-official">
                  </i>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="https://www.instagram.com/oclock_io/" target="_blank" title="instagram" class="text-muted text-hover-primary">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              ...
              <?php foreach($viewVars['types'] as $types): ?>
              <li> <a href=" <?= $this->router->generate('catalog_type', ['id' => $types->getID()]); ?>" class="text-muted"> 
              <?= $types->getName()  ;?>
              </a></li>
              <?php endforeach; ?>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($viewVars['brands'] as $brands): ?>
              
              <li> <a href=" <?= $this->router->generate('catalog_brand', ['id' => $brands->getID()]); ?>" class="text-muted"> 
              <?= $brands->getName()  ;?>
              </a></li>
              <?php endforeach; ?>
            </ul>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <img src="<?= $viewVars['baseURL'] ?>/assets/img/visa.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $viewVars['baseURL'] ?>/assets/img/mastercard.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $viewVars['baseURL'] ?>/assets/img/paypal.svg" alt="..." class="payment-icon">
              </li>
            </ul>
          </div>
        </div>
  ...
  <!-- JS -->
  <script src="<?= $viewVars['baseURL'] ?>/assets/js/jquery.min.js"></script>
  <script src="<?= $viewVars['baseURL'] ?>/assets/js/popper.min.js"></script>
  <script src="<?= $viewVars['baseURL'] ?>/assets/js/bootstrap.min.js"></script>
  <script src="<?= $viewVars['baseURL'] ?>/assets/js/owl.carousel.min.js"></script>
